...
!----------------------------------------------------------------------
  ...
  subroutine bandpassSeismo(x, n, delta_t, x_filt)
  use seismo_variables
  implicit none
...
!----------------------------------------------------------------------
  ...
  obs_lp(:) = 0.
  synt_lp(:) = 0.
  call bandpassSeismo(obs,npts,dt,obs_lp)
  call bandpassSeismo(synt,npts,dt,synt_lp)
